...
jagged1 * mesh_qc_bd_layer_0_hyperfaces(const mesh * m)
{
  ...
  jagged1_set(m_bd_layer_0_hyperfaces, m_bd_layer_0_hyperfaces_a0,
              m_bd_layer_0_hyperfaces_a1);
  ...
  const mesh * m, const jagged1 * m_bd_layer_0_hyperfaces)
{
  ...
  m_bd_layer_0_cells_duplicated_a1 = 
    (int *) malloc(m_bd_layer_0_cells_duplicated_a0 * sizeof(int));
  /* NULL pointer check */
  ...
  jagged1_set(m_bd_layer_0_cells_duplicated, m_bd_layer_0_cells_duplicated_a0,
              m_bd_layer_0_cells_duplicated_a1);
  m_bd_layer_0_cells = list_delete_duplicates(m_bd_layer_0_cells_duplicated);
  /* NULL pointer check */
  ...
  const mesh * m, const jagged1 * m_bd_layer_0_cells)
{
  ...
  jagged1_set(m_bd_layer_0_1_nodes_original, m_bd_layer_0_1_nodes_original_a0,
              m_bd_layer_0_1_nodes_original_a1);
  m_bd_layer_0_1_nodes = list_delete_duplicates(m_bd_layer_0_1_nodes_original);
  /* NULL pointer check */
