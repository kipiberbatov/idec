...
int main(int argc, char ** argv)
{
  ...
  if (!strcmp(direction_name, "horizontal"))
    direction = idec_graphics_colorbar_direction_horizontal;
  else if (!strcmp(direction_name, "vertical"))
    direction = idec_graphics_colorbar_direction_vertical;
  else
  {
    color_error_position(__FILE__, __LINE__);
    fprintf(stderr,
  ...
  animation.draw_snapshot = idec_graphics_colorbar_draw_snapshot;
