...
static void idec_graphics_colorbar_draw_rectangles_horizontal(
...
static void idec_graphics_colorbar_draw_rectangles_vertical(
  struct idec_graphics_rectangle * rectangle,
  void * canvas,
  int * status,
  double width,
  ...
  const struct idec_graphics_colorbar_draw_functions * functions)
{
  ...
  if (direction == idec_graphics_colorbar_direction_horizontal)
    drawer = idec_graphics_colorbar_draw_rectangles_horizontal;
  else if (direction == idec_graphics_colorbar_direction_vertical)
    drawer = idec_graphics_colorbar_draw_rectangles_vertical;
  else
  {
    color_error_position(__FILE__, __LINE__);
