...
\input{inner_product/induced_isomorphism_with_dual_proposition.tex}
...
\input{hodge_star/unorthodox_sign_convention_wrong_reason-remark.tex}
...
\subsection{Primal strong formulation}
\subsubsection{Steady-state}
\input{diffusion/discrete/steady_state/primal_strong_with_normals-discussion.tex}
\subsubsection{Transient}
