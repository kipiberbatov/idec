...
% \input{heat_transport/continuous/weak_primal_model-formulation.tex}
% \begin{formulation}
% \input{heat_transport/continuous/weak_primal_model-formulation.tex}
% \end{formulation}
% \input{heat_transport/continuous/weak_primal_model-formulation.tex}
...
\input{jagged_array/concept-definition.tex}
\input{jagged_array/concept-example.tex}
\input{jagged_array/memory_representation-definition.tex}
\input{jagged_array/memory_representation-example.tex}

\section{Meshes}
\label{section:meshes}
\input{mesh/concept-definition.tex}
\input{mesh/memory_representation-definition.tex}
\input{mesh/memory_representation-example.tex}
...
\input{mesh/forman_subdivision/is_quasi_cubical__in_3d_iff_original_is_simple-proposition.tex}
...
\input{heat_transport/continuous/strong_model-formulation.tex}
