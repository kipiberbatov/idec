...
\input{mesh/interval_simplicial_are_not_unkommon-discussion.tex}
...
\input{mesh/quasi_cubical/adjoint_coboundary/closed_form-proposition.tex}
...
\input{mesh/quasi_cubical/hodge_star/closed_form-proposition.tex}
...
\input{heat_transport/continuous/introduction-discussion.tex}
\input{heat_transport/continuous/model_with_differential_forms-discussion.tex}
\subsection{Primal strong formulation}
\subsubsection{Transient}
\input{heat_transport/continuous/primal_strong_transient-formulation.tex}
\subsubsection{Steady-state}
\input{heat_transport/continuous/primal_strong_steady_state-formulation.tex}
\subsection{Primal weak formulation}
\subsubsection{Transient}
\input{heat_transport/continuous/primal_weak_transient-discussion.tex}
\input{heat_transport/continuous/primal_weak_transient-formulation.tex}
\subsubsection{Steady-state}
\input{heat_transport/continuous/primal_weak_steady_state-formulation.tex}
\subsection{Mixed weak formulation}
\subsubsection{Transient}
\input{heat_transport/continuous/mixed_weak_transient-discussion.tex}
\input{heat_transport/continuous/mixed_weak_transient-formulation.tex}
\subsubsection{Steady-state}
\input{heat_transport/continuous/mixed_weak_steady_state-formulation.tex}
...
\subsection{Primal strong formulation}
\subsubsection{Steady-state}
\input{heat_transport/discrete/model_with_normals-discussion.tex}
\subsubsection{Transient}
\input{heat_transport/discrete/strong_model_with_normals-formulation.tex}
\input{heat_transport/discrete/strong_model_with_normals_crank_nicolson_scheme-discussion.tex}
\subsection{Primal weak formulation}
\subsubsection{Steady-state}
\input{heat_transport/discrete/primal_weak_steady_state-formulation.tex}
\input{heat_transport/discrete/primal_weak_steady_state_solve-discussion.tex}
\subsubsection{Transient}
\input{heat_transport/discrete/primal_weak_transient-formulation.tex}
\input{heat_transport/discrete/primal_weak_transient_solve_trapezoidal-discussion.tex}
\input{heat_transport/discrete/primal_weak_transient_solve_trapezoidal-algorithm.tex}
\subsection{Mixed weak formulation}
\subsubsection{Steady-state}
\input{heat_transport/discrete/mixed_weak_steady_state-formulation.tex}
\input{heat_transport/discrete/mixed_weak_steady_state_solve-discussion.tex}
\subsubsection{Transient}
\input{heat_transport/discrete/mixed_weak_transient-formulation.tex}
\input{heat_transport/discrete/mixed_weak_transient_solve_trapezoidal-discussion.tex}
\input{heat_transport/discrete/mixed_weak_transient_solve_trapezoidal-algorithm.tex}

\section{Examples of transport phenomena (e.g., heat transport)}
\label{section:examples_of_transport_phenomena}
\input{heat_transport/continuous/2d_d00_p00-example.tex}
\input{heat_transport/continuous/2d_d00_p00-figure.tex}
\input{heat_transport/continuous/2d_d00_p01-example.tex}
\input{heat_transport/continuous/2d_d00_p01-figure.tex}
\input{heat_transport/continuous/2d_d00_p02-example.tex}
\input{heat_transport/continuous/2d_d00_p02-figure.tex}
\input{heat_transport/continuous/2d_d00_p03-example.tex}
\input{heat_transport/continuous/2d_d00_p03-figure.tex}
\input{heat_transport/continuous/2d_d00_p04-example.tex}
\input{heat_transport/continuous/2d_d00_p04-figure.tex}
\input{heat_transport/continuous/2d_d00_p05-example.tex}
\input{heat_transport/continuous/2d_d00_p05-figure.tex}
\input{heat_transport/continuous/2d_d01_p00-example.tex}
\input{heat_transport/continuous/2d_d01_p00-figure.tex}
\input{heat_transport/continuous/2d_d02_p00-example.tex}
\input{heat_transport/continuous/2d_d02_p00-figure.tex}
\input{heat_transport/continuous/2d_d02_p01-example.tex}
\input{heat_transport/continuous/2d_d02_p01-figure.tex}
\input{heat_transport/continuous/2d_d03_p00-example.tex}
\input{heat_transport/continuous/2d_d03_p00-figure.tex}
\input{heat_transport/continuous/2d_d03_p01-example.tex}
\input{heat_transport/continuous/2d_d03_p01-figure.tex}
...
\input{mesh/quasi_cubical/bundle_valued_chain/concept-definition.tex}
\input{mesh/quasi_cubical/bundle_valued_chain/cup_product-definition.tex}
\input{mesh/quasi_cubical/bundle_valued_chain/cup_product-remark.tex}
\input{mesh/quasi_cubical/covariant_exterior_derivative/concept-definition.tex}
\input{mesh/quasi_cubical/covariant_exterior_derivative/leibniz_rule-proposition.tex}
\input{mesh/quasi_cubical/covariant_exterior_derivative/leibniz_rule-proof.tex}
\input{mesh/quasi_cubical/covariant_exterior_derivative/graded_leibniz_rule-proposition.tex}
\input{mesh/quasi_cubical/covariant_exterior_derivative/graded_leibniz_rule-proof.tex}
