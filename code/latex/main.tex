...
\input{heat_transport/continuous/weak_mixed_model-formulation.tex}
...
\subsection{Mixed weak formulation}
\phantom{T}
% \input{heat_transport/discrete/mixed_weak-formulation.tex}
...
%\input{mesh/quasi_cubical/covariant_exterior_derivative/tmp-example.tex}
