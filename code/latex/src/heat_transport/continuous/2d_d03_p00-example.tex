\begin{example}
  ...
  \Cref{figure:idec/diffusion/steady_state/continuous_2d_d03_p00/circular_4_3_forman}
  ($(n_a, n_d) = (4, 3)$)
  and
  \Cref{figure:idec/diffusion/steady_state/continuous_2d_d03_p00/circular_18_10_forman}
  ($(n_a, n_d) = (18, 10)$).
\end{example}
