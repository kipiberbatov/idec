\begin{discussion}
  \label{idec/diffusion/discrete/transient/primal_weak_solve_trapezoidal-discussion}
  We are going to derive a solution to
  \Cref{idec/diffusion/discrete/transient/primal_weak-formulation}
...
%
  ...
  \Cref{idec/diffusion/discrete/steady_state/primal_weak_solve-discussion},
