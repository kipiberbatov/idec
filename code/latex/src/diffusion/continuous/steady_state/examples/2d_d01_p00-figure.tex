\begin{figure}[!ht]
  ...
  \caption{%
    ...
    (\Cref{cmc/diffusion/continuous/steady_state/examples/2d_d01_p00-example}):
    solutions for potential}
  \label{figure:cmc/diffusion/steady_state/continuous_2d_d01_p00/square_8_potential}
\end{figure}
\begin{figure}[!ht]
  \begin{subfigure}{.24\textwidth}
    \centering
  ...
  \label{figure:cmc/diffusion/steady_state/continuous_2d_d01_p00/square_8_flow_rate}
\end{figure}
