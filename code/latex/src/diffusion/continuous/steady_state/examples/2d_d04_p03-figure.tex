\begin{figure}[!ht]
  ...
  \caption{%
    ...
    (\Cref{idec/diffusion/continuous/steady_state/examples/2d_d04_p03-example}):
    solutions for potential on mesh \verb|hemisphere_polar_4_3_forman|}
  \label{figure:idec/diffusion/steady_state/continuous_2d_d04_p03/hemisphere_polar_4_3_forman_potential}
\end{figure}
\begin{figure}[!ht]
  \begin{subfigure}{.32\textwidth}
    \centering
  ...
  \label{figure:idec/diffusion/steady_state/continuous_2d_d04_p03/hemisphere_polar_4_3_forman_flow_rate}
\end{figure}
\begin{figure}[!ht]
  \begin{subfigure}{.32\textwidth}
    \centering
  ...
  \label{figure:idec/diffusion/steady_state/continuous_2d_d04_p03/hemisphere_polar_6_6_forman_potential}
\end{figure}
\begin{figure}[!ht]
  \begin{subfigure}{.32\textwidth}
    \centering
  ...
  \label{figure:idec/diffusion/steady_state/continuous_2d_d04_p03/hemisphere_polar_6_6_forman_flow_rate}
\end{figure}
