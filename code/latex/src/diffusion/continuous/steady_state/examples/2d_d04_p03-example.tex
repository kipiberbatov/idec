\begin{example}
  ...
  are shown on
  \Cref{figure:cmc/diffusion/steady_state/continuous_2d_d04_p03/hemisphere_polar_4_3_forman_potential},
  \Cref{figure:cmc/diffusion/steady_state/continuous_2d_d04_p03/hemisphere_polar_4_3_forman_flow_rate}
  ($(n_a, n_d) = (4, 3)$)
  and
  \Cref{figure:cmc/diffusion/steady_state/continuous_2d_d04_p03/hemisphere_polar_6_6_forman_potential},
  \Cref{figure:cmc/diffusion/steady_state/continuous_2d_d04_p03/hemisphere_polar_6_6_forman_flow_rate}
  ($(n_a, n_d) = (6, 6)$).
\end{example}
