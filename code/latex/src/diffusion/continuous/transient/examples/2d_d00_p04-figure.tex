\begin{figure}[!ht]
  ...
  \begin{subfigure}{.24\textwidth}
    \centering
    \includegraphics[scale=.19, page=1]
    {diffusion/transient/continuous_2d_d00_p04/primal_weak_cochain_brick_2d_5_forman_trapezoidal_0p001_2500_potential}
  ...
  \caption{%
    ...
    (\Cref{idec/diffusion/continuous/transient/examples/2d_d00_p04-example}):
...
\begin{figure}[!ht]
  \begin{subfigure}{.24\textwidth}
    \centering
    \includegraphics[scale=.19, page=1]
    {diffusion/transient/continuous_2d_d00_p04/primal_strong_cochain_brick_2d_5_forman_trapezoidal_0p001_2500_flow_rate}
    \caption{Primal strong, 1}
  \end{subfigure}
  \begin{subfigure}{.24\textwidth}
    \centering
  ...
  \begin{subfigure}{.24\textwidth}
    \centering
    \includegraphics[scale=.19, page=1]
    {diffusion/transient/continuous_2d_d00_p04/primal_weak_cochain_brick_2d_5_forman_trapezoidal_0p001_2500_flow_rate}
    \caption{Primal weak, 1}
  \end{subfigure}
  \begin{subfigure}{.24\textwidth}
    \centering
