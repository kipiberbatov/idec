\begin{figure}[!ht]
  ...
  \caption{%
    ...
    (\Cref{idec/diffusion/continuous/transient/examples/2d_d00_p02-example}):
...
\begin{figure}[!ht]
  ...
  \label{figure:idec/diffusion/transient/continuous_2d_d00_p02/brick_2d_5_forman_trapezoidal_0p001_1000_flow_rate}
\end{figure}
