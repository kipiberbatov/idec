_demo_pdf :=\
  ...
  build/$(MODE)/demo/pdf/mesh_circular_4_3_edge_skeleton.pdf\
  build/$(MODE)/demo/pdf/mesh_circular_4_3_forman_edge_skeleton.pdf\
  build/$(MODE)/demo/pdf/mesh_circular_17_10_edge_skeleton.pdf\
  build/$(MODE)/demo/pdf/mesh_circular_17_10_forman_edge_skeleton.pdf\
  build/$(MODE)/demo/pdf/mesh_pentagon_edge_skeleton.pdf\
  build/$(MODE)/demo/pdf/mesh_pentagon_forman_edge_skeleton.pdf\
  build/$(MODE)/demo/pdf/mesh_brick_2d_1_forman_edge_skeleton.pdf\
  build/$(MODE)/demo/pdf/mesh_brick_2d_10_forman_edge_skeleton.pdf\
  build/$(MODE)/demo/pdf/mesh_2d_10_grains_edge_skeleton.pdf\
  build/$(MODE)/demo/pdf/mesh_2d_10_grains_forman_edge_skeleton.pdf\
  build/$(MODE)/demo/pdf/mesh_brick_2d_2_forman_diffusion_transient_continuous_p0_temperature.pdf\
  build/$(MODE)/demo/pdf/mesh_brick_2d_2_forman_diffusion_transient_continuous_p0_flux.pdf\
  build/$(MODE)/demo/pdf/mesh_brick_2d_2_forman_diffusion_steady_state_continuous_p4_primal_weak_temperature.pdf\
  build/$(MODE)/demo/pdf/mesh_brick_2d_5_forman_diffusion_transient_continuous_p2_temperature.pdf\
  build/$(MODE)/demo/pdf/mesh_brick_2d_5_forman_diffusion_transient_continuous_p4_temperature.pdf\
  build/$(MODE)/demo/pdf/mesh_brick_2d_5_forman_diffusion_steady_state_continuous_p4_temperature.pdf\
  build/$(MODE)/demo/pdf/mesh_brick_2d_10_forman_diffusion_transient_continuous_p4_temperature.pdf\
  build/$(MODE)/demo/pdf/mesh_brick_2d_10_forman_diffusion_transient_continuous_p4_flux.pdf\
  build/$(MODE)/demo/pdf/mesh_2d_10_grains_forman_diffusion_steady_state_continuous_p7_temperature.pdf\
  build/$(MODE)/demo/pdf/mesh_2d_10_grains_forman_diffusion_steady_state_continuous_p7_primal_weak_temperature.pdf\
  build/$(MODE)/demo/pdf/mesh_square_8_diffusion_transient_continuous_p5_temperature.pdf\
  build/$(MODE)/demo/pdf/diffusion_2d_steady_state_discrete_primal_weak_p4_brick_2d_2_forman_temperature.pdf\
  build/$(MODE)/demo/pdf/diffusion_2d_steady_state_discrete_mixed_weak_p4_brick_2d_2_forman_temperature.pdf\
  build/$(MODE)/demo/pdf/diffusion_2d_steady_state_discrete_primal_weak_p9_circular_4_3_forman_temperature.pdf\
  build/$(MODE)/demo/pdf/diffusion_2d_steady_state_discrete_primal_weak_p9_circular_17_10_forman_temperature.pdf\
