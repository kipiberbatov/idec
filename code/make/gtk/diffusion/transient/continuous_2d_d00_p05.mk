.PHONY: gtk_diffusion_transient_continuous_2d_d00_p05\
        gtk_diffusion_transient_continuous_2d_d00_p05_clean\
        gtk_diffusion_transient_continuous_2d_d00_p05_distclean

build/$(MODE)/gtk/diffusion/transient/continuous_2d_d00_p05:\
  | build/$(MODE)/gtk/diffusion/transient
	mkdir -p $@

_gtk_diffusion_transient_continuous_2d_d00_p05 :=\
  build/$(MODE)/gtk/diffusion/transient/continuous_2d_d00_p05/primal_strong_cochain_brick_2d_5_forman_trapezoidal_0p001_2500_potential.log\
  build/$(MODE)/gtk/diffusion/transient/continuous_2d_d00_p05/primal_strong_cochain_brick_2d_5_forman_trapezoidal_0p001_2500_flow_rate.log\
  build/$(MODE)/gtk/diffusion/transient/continuous_2d_d00_p05/primal_weak_cochain_brick_2d_5_forman_trapezoidal_0p001_2500_potential.log\
  build/$(MODE)/gtk/diffusion/transient/continuous_2d_d00_p05/primal_weak_cochain_brick_2d_5_forman_trapezoidal_0p001_2500_flow_rate.log\
  build/$(MODE)/gtk/diffusion/transient/continuous_2d_d00_p05/mixed_weak_cochain_brick_2d_5_forman_trapezoidal_0p001_2500_potential.log\
  build/$(MODE)/gtk/diffusion/transient/continuous_2d_d00_p05/mixed_weak_cochain_brick_2d_5_forman_trapezoidal_0p001_2500_flow_rate.log\
...
build/$(MODE)/gtk/diffusion/transient/continuous_2d_d00_p05/primal_strong_cochain_brick_2d_5_forman_trapezoidal_0p001_2500_potential.log:\
  ...
  --title=2d_d00_p05_primal_strong_brick_2d_5_forman_potential\
...
build/$(MODE)/gtk/diffusion/transient/continuous_2d_d00_p05/primal_strong_cochain_brick_2d_5_forman_trapezoidal_0p001_2500_flow_rate.log:\
  ...
  --animation-library=$(word 3, $|)\
  --animation-backend=cmc_cairo_gtk_animation\
  --title=2d_d00_p05_primal_strong_brick_2d_5_forman_flow_rate\
  --close-automatically=$(CLOSE_AUTOMATICALLY)\
  --timelapse=$(TIMELAPSE)\
  --output=$@
...
build/$(MODE)/gtk/diffusion/transient/continuous_2d_d00_p05/primal_weak_cochain_brick_2d_5_forman_trapezoidal_0p001_2500_potential.log:\
  ...
  --animation-library=$(word 3, $|)\
  --animation-backend=cmc_cairo_gtk_animation\
  --title=2d_d00_p05_primal_weak_brick_2d_5_forman_potential\
  --close-automatically=$(CLOSE_AUTOMATICALLY)\
  --timelapse=$(TIMELAPSE)\
  --output=$@
...
build/$(MODE)/gtk/diffusion/transient/continuous_2d_d00_p05/primal_weak_cochain_brick_2d_5_forman_trapezoidal_0p001_2500_flow_rate.log:\
  ...
  --animation-library=$(word 3, $|)\
  --animation-backend=cmc_cairo_gtk_animation\
  --title=2d_d00_p05_primal_weak_brick_2d_5_forman_flow_rate\
  --close-automatically=$(CLOSE_AUTOMATICALLY)\
  --timelapse=$(TIMELAPSE)\
  --output=$@
...
build/$(MODE)/gtk/diffusion/transient/continuous_2d_d00_p05/mixed_weak_cochain_brick_2d_5_forman_trapezoidal_0p001_2500_potential.log:\
  ...
  --animation-library=$(word 3, $|)\
  --animation-backend=cmc_cairo_gtk_animation\
  --title=2d_d00_p05_mixed_weak_brick_2d_5_forman_potential\
  --close-automatically=$(CLOSE_AUTOMATICALLY)\
  --timelapse=$(TIMELAPSE)\
  --output=$@
...
build/$(MODE)/gtk/diffusion/transient/continuous_2d_d00_p05/mixed_weak_cochain_brick_2d_5_forman_trapezoidal_0p001_2500_flow_rate.log:\
  ...
  --animation-library=$(word 3, $|)\
  --animation-backend=cmc_cairo_gtk_animation\
  --title=2d_d00_p05_mixed_weak_brick_2d_5_forman_flow_rate\
  --close-automatically=$(CLOSE_AUTOMATICALLY)\
  --timelapse=$(TIMELAPSE)\
  --output=$@

gtk_diffusion_transient_continuous_2d_d00_p05:\
  $(_gtk_diffusion_transient_continuous_2d_d00_p05)

gtk_diffusion_transient_continuous_2d_d00_p05_clean:
	-$(RM) $(_gtk_diffusion_transient_continuous_2d_d00_p05)

gtk_diffusion_transient_continuous_2d_d00_p05_distclean:
	-$(RM) -r build/$(MODE)/gtk/diffusion/transient/continuous_2d_d00_p05
