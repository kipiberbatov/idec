_pdf_diffusion_steady_state_continuous_2d_d01_p00 :=\
  build/$(MODE)/pdf/diffusion/steady_state_continuous_2d_d01_p00_exact_square_8_potential.pdf\
  build/$(MODE)/pdf/diffusion/steady_state_continuous_2d_d01_p00_exact_square_8_flow.pdf\
  build/$(MODE)/pdf/diffusion/steady_state_continuous_2d_d01_p00_primal_strong_cochain_square_8_potential.pdf\
  build/$(MODE)/pdf/diffusion/steady_state_continuous_2d_d01_p00_primal_strong_cochain_square_8_flow.pdf\
  build/$(MODE)/pdf/diffusion/steady_state_continuous_2d_d01_p00_primal_weak_cochain_square_8_potential.pdf\
  build/$(MODE)/pdf/diffusion/steady_state_continuous_2d_d01_p00_primal_weak_cochain_square_8_flow.pdf\
  build/$(MODE)/pdf/diffusion/steady_state_continuous_2d_d01_p00_mixed_weak_cochain_square_8_potential.pdf\
  build/$(MODE)/pdf/diffusion/steady_state_continuous_2d_d01_p00_mixed_weak_cochain_square_8_flow.pdf\
