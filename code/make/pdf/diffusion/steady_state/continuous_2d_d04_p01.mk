...
_pdf_diffusion_steady_state_continuous_2d_d04_p01 :=\
  build/$(MODE)/pdf/diffusion/steady_state/continuous_2d_d04_p01/exact_hemisphere_4_3_forman_potential.pdf\
  build/$(MODE)/pdf/diffusion/steady_state/continuous_2d_d04_p01/exact_hemisphere_4_3_forman_flow.pdf\
  build/$(MODE)/pdf/diffusion/steady_state/continuous_2d_d04_p01/primal_weak_cochain_hemisphere_4_3_forman_potential.pdf\
  build/$(MODE)/pdf/diffusion/steady_state/continuous_2d_d04_p01/primal_weak_cochain_hemisphere_4_3_forman_flow.pdf\
  build/$(MODE)/pdf/diffusion/steady_state/continuous_2d_d04_p01/mixed_weak_cochain_hemisphere_4_3_forman_potential.pdf\
  build/$(MODE)/pdf/diffusion/steady_state/continuous_2d_d04_p01/mixed_weak_cochain_hemisphere_4_3_forman_flow.pdf\
  build/$(MODE)/pdf/diffusion/steady_state/continuous_2d_d04_p01/exact_hemisphere_6_6_forman_potential.pdf\
  build/$(MODE)/pdf/diffusion/steady_state/continuous_2d_d04_p01/exact_hemisphere_6_6_forman_flow.pdf\
  build/$(MODE)/pdf/diffusion/steady_state/continuous_2d_d04_p01/primal_weak_cochain_hemisphere_6_6_forman_potential.pdf\
  build/$(MODE)/pdf/diffusion/steady_state/continuous_2d_d04_p01/primal_weak_cochain_hemisphere_6_6_forman_flow.pdf\
  build/$(MODE)/pdf/diffusion/steady_state/continuous_2d_d04_p01/mixed_weak_cochain_hemisphere_6_6_forman_potential.pdf\
  build/$(MODE)/pdf/diffusion/steady_state/continuous_2d_d04_p01/mixed_weak_cochain_hemisphere_6_6_forman_flow.pdf\
...
build/$(MODE)/pdf/diffusion/steady_state/continuous_2d_d04_p01/exact_hemisphere_4_3_forman_flow.pdf:\
  ...
  build/$(MODE)/txt/mesh/hemisphere_4_3_forman.txt\
  build/$(MODE)/txt/diffusion/steady_state/continuous_2d_d04_p01/exact_hemisphere_4_3_forman_flow.txt\
...
build/$(MODE)/pdf/diffusion/steady_state/continuous_2d_d04_p01/primal_weak_cochain_hemisphere_4_3_forman_flow.pdf:\
  build/$(MODE)/bin/idec_graphics_mesh_2d_1_cochain_sequence$(.EXE)\
  build/$(MODE)/txt/mesh/hemisphere_4_3_forman.txt\
  build/$(MODE)/txt/diffusion/steady_state/continuous_2d_d04_p01/primal_weak_cochain_hemisphere_4_3_forman_flow.txt\
  build/$(MODE)/obj/plugins/idec_cairo_graphics_draw_functions_mesh_2d_1_cochain_sequence_circular_forman$(.OBJ)\
  build/$(MODE)/obj/plugins/idec_cairo_pdf_animation$(.OBJ)\
  | build/$(MODE)/pdf/diffusion/steady_state/continuous_2d_d04_p01\
    build/$(MODE)/lib/plugins/libcanvas$(.DLL)\
...
build/$(MODE)/pdf/diffusion/steady_state/continuous_2d_d04_p01/exact_hemisphere_6_6_forman_flow.pdf:\
  build/$(MODE)/bin/idec_graphics_mesh_2d_1_cochain_sequence$(.EXE)\
  build/$(MODE)/txt/mesh/hemisphere_6_6_forman.txt\
  build/$(MODE)/txt/diffusion/steady_state/continuous_2d_d04_p01/exact_hemisphere_6_6_forman_flow.txt\
  build/$(MODE)/obj/plugins/idec_cairo_graphics_draw_functions_mesh_2d_1_cochain_sequence_circular_forman$(.OBJ)\
  build/$(MODE)/obj/plugins/idec_cairo_pdf_animation$(.OBJ)\
  | build/$(MODE)/pdf/diffusion/steady_state/continuous_2d_d04_p01\
    build/$(MODE)/lib/plugins/libcanvas$(.DLL)\
...
build/$(MODE)/pdf/diffusion/steady_state/continuous_2d_d04_p01/primal_weak_cochain_hemisphere_6_6_forman_flow.pdf:\
  build/$(MODE)/bin/idec_graphics_mesh_2d_1_cochain_sequence$(.EXE)\
  build/$(MODE)/txt/mesh/hemisphere_6_6_forman.txt\
  build/$(MODE)/txt/diffusion/steady_state/continuous_2d_d04_p01/primal_weak_cochain_hemisphere_6_6_forman_flow.txt\
  build/$(MODE)/obj/plugins/idec_cairo_graphics_draw_functions_mesh_2d_1_cochain_sequence_circular_forman$(.OBJ)\
  build/$(MODE)/obj/plugins/idec_cairo_pdf_animation$(.OBJ)\
  | build/$(MODE)/pdf/diffusion/steady_state/continuous_2d_d04_p01\
    build/$(MODE)/lib/plugins/libcanvas$(.DLL)\
