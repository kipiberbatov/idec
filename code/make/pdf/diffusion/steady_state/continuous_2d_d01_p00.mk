.PHONY: pdf_diffusion_steady_state_continuous_2d_d01_p00\
        pdf_diffusion_steady_state_continuous_2d_d01_p00_clean\
        pdf_diffusion_steady_state_continuous_2d_d01_p00_distclean

build/$(MODE)/pdf/diffusion/steady_state/continuous_2d_d01_p00:\
...
_pdf_diffusion_steady_state_continuous_2d_d01_p00 :=\
  ...
  build/$(MODE)/pdf/diffusion/steady_state/continuous_2d_d01_p00/exact_square_8_flow.pdf\
  build/$(MODE)/pdf/diffusion/steady_state/continuous_2d_d01_p00/primal_strong_cochain_square_8_potential.pdf\
  build/$(MODE)/pdf/diffusion/steady_state/continuous_2d_d01_p00/primal_strong_cochain_square_8_flow.pdf\
  build/$(MODE)/pdf/diffusion/steady_state/continuous_2d_d01_p00/primal_weak_cochain_square_8_potential.pdf\
  build/$(MODE)/pdf/diffusion/steady_state/continuous_2d_d01_p00/primal_weak_cochain_square_8_flow.pdf\
  build/$(MODE)/pdf/diffusion/steady_state/continuous_2d_d01_p00/mixed_weak_cochain_square_8_potential.pdf\
  build/$(MODE)/pdf/diffusion/steady_state/continuous_2d_d01_p00/mixed_weak_cochain_square_8_flow.pdf\
...
build/$(MODE)/pdf/diffusion/steady_state/continuous_2d_d01_p00/exact_square_8_flow.pdf:\
  ...
  build/$(MODE)/txt/mesh/square_8.txt\
  build/$(MODE)/txt/diffusion/steady_state/continuous_2d_d01_p00/exact_square_8_flow.txt\
...
build/$(MODE)/pdf/diffusion/steady_state/continuous_2d_d01_p00/primal_strong_cochain_square_8_flow.pdf:\
  build/$(MODE)/bin/idec_graphics_mesh_2d_1_cochain_sequence$(.EXE)\
  build/$(MODE)/txt/mesh/square_8.txt\
  build/$(MODE)/txt/diffusion/steady_state/continuous_2d_d01_p00/primal_strong_cochain_square_8_flow.txt\
  build/$(MODE)/obj/plugins/idec_cairo_graphics_draw_functions_mesh_2d_1_cochain_sequence$(.OBJ)\
  build/$(MODE)/obj/plugins/idec_cairo_pdf_animation$(.OBJ)\
  | build/$(MODE)/pdf/diffusion/steady_state/continuous_2d_d01_p00\
    build/$(MODE)/lib/plugins/libcanvas$(.DLL)\
...
build/$(MODE)/pdf/diffusion/steady_state/continuous_2d_d01_p00/primal_weak_cochain_square_8_flow.pdf:\
  build/$(MODE)/bin/idec_graphics_mesh_2d_1_cochain_sequence$(.EXE)\
  build/$(MODE)/txt/mesh/square_8.txt\
  build/$(MODE)/txt/diffusion/steady_state/continuous_2d_d01_p00/primal_weak_cochain_square_8_flow.txt\
  build/$(MODE)/obj/plugins/idec_cairo_graphics_draw_functions_mesh_2d_1_cochain_sequence$(.OBJ)\
  build/$(MODE)/obj/plugins/idec_cairo_pdf_animation$(.OBJ)\
  | build/$(MODE)/pdf/diffusion/steady_state/continuous_2d_d01_p00\
    build/$(MODE)/lib/plugins/libcanvas$(.DLL)\
...
pdf_diffusion_steady_state_continuous_2d_d01_p00:\
  $(_pdf_diffusion_steady_state_continuous_2d_d01_p00)

pdf_diffusion_steady_state_continuous_2d_d01_p00_clean:
	-$(RM) $(_pdf_diffusion_steady_state_continuous_2d_d01_p00)

pdf_diffusion_steady_state_continuous_2d_d01_p00_distclean:
	-$(RM) -r build/$(MODE)/pdf/diffusion/steady_state/continuous_2d_d01_p00
