.PHONY: txt_diffusion_transient_continuous_2d_d00_p05\
        txt_diffusion_transient_continuous_2d_d00_p05_clean\
        txt_diffusion_transient_continuous_2d_d00_p05_distclean

build/$(MODE)/txt/diffusion/transient/continuous_2d_d00_p05:\
...
build/$(MODE)/txt/diffusion/transient/continuous_2d_d00_p05/primal_strong_cochain_brick_2d_5_forman_input.txt:\
  ...
  build/$(MODE)/obj/plugins/diffusion_transient_continuous_2d_d00_p05$(.OBJ)\
  | build/$(MODE)/txt/diffusion/transient/continuous_2d_d00_p05\
    build/$(MODE)/lib/plugins/libdiffusion$(.DLL)
	$<\
  --mesh=$(word 2, $^)\
  --dynamic-library=$(word 2, $|)\
  --input-data=diffusion_transient_continuous_2d_d00_p05\
  > $@
...
txt_diffusion_transient_continuous_2d_d00_p05:\
  $(_txt_diffusion_transient_continuous_2d_d00_p05)

txt_diffusion_transient_continuous_2d_d00_p05_clean:
	-$(RM) $(_txt_diffusion_transient_continuous_2d_d00_p05)

txt_diffusion_transient_continuous_2d_d00_p05_distclean:
	-$(RM) -r build/$(MODE)/txt/diffusion/transient/continuous_2d_d00_p05
