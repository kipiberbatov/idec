.PHONY: txt_diffusion_transient_continuous_2d_d00_p03\
        txt_diffusion_transient_continuous_2d_d00_p03_clean\
        txt_diffusion_transient_continuous_2d_d00_p03_distclean

build/$(MODE)/txt/diffusion/transient/continuous_2d_d00_p03:\
  | build/$(MODE)/txt/diffusion/transient
	mkdir -p $@

_txt_diffusion_transient_continuous_2d_d00_p03 :=\
  build/$(MODE)/txt/diffusion/transient/continuous_2d_d00_p03/primal_strong_cochain_brick_2d_5_forman_input.txt\
  ...
  build/$(MODE)/txt/diffusion/transient/continuous_2d_d00_p03/primal_weak_cochain_brick_2d_5_forman_input.txt\
  ...
  build/$(MODE)/txt/diffusion/transient/continuous_2d_d00_p03/mixed_weak_cochain_brick_2d_5_forman_input.txt\
...
build/$(MODE)/txt/diffusion/transient/continuous_2d_d00_p03/primal_strong_cochain_brick_2d_5_forman_input.txt:\
  ...
  build/$(MODE)/obj/plugins/diffusion_transient_continuous_2d_d00_p03$(.OBJ)\
  | build/$(MODE)/txt/diffusion/transient/continuous_2d_d00_p03\
    build/$(MODE)/lib/plugins/libdiffusion$(.DLL)
	$<\
  --mesh=$(word 2, $^)\
  --dynamic-library=$(word 2, $|)\
  --input-data=diffusion_transient_continuous_2d_d00_p03\
  > $@
...
txt_diffusion_transient_continuous_2d_d00_p03:\
  $(_txt_diffusion_transient_continuous_2d_d00_p03)

txt_diffusion_transient_continuous_2d_d00_p03_clean:
	-$(RM) $(_txt_diffusion_transient_continuous_2d_d00_p03)

txt_diffusion_transient_continuous_2d_d00_p03_distclean:
	-$(RM) -r build/$(MODE)/txt/diffusion/transient/continuous_2d_d00_p03
