_txt_diffusion_steady_state_continuous_2d_d02_p00 :=\
  ...
  build/$(MODE)/txt/diffusion/steady_state/continuous_2d_d02_p00_primal_strong_cochain_2d_10_grains_forman_input.txt\
  ...
  build/$(MODE)/txt/diffusion/steady_state/continuous_2d_d02_p00_primal_weak_cochain_2d_10_grains_forman_input.txt\
  ...
  build/$(MODE)/txt/diffusion/steady_state/continuous_2d_d02_p00_mixed_weak_cochain_2d_10_grains_forman_input.txt\
...
build/$(MODE)/txt/diffusion/steady_state/continuous_2d_d02_p00_exact_2d_10_grains_forman_flow.txt:\
  ...
  --raw $(word 2, $^)\
  $(word 2, $|)\
  diffusion_steady_state_continuous_2d_d02_p00_flow\
  --raw > $@
