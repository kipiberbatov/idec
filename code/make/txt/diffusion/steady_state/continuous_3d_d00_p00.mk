_txt_diffusion_steady_state_continuous_3d_d00_p00 :=\
  build/$(MODE)/txt/diffusion/steady_state/continuous_3d_d00_p00_exact_brick_3d_2_forman_potential.txt\
  build/$(MODE)/txt/diffusion/steady_state/continuous_3d_d00_p00_primal_strong_cochain_brick_3d_2_forman_input.txt\
  build/$(MODE)/txt/diffusion/steady_state/continuous_3d_d00_p00_primal_strong_cochain_brick_3d_2_forman_potential.txt\
  build/$(MODE)/txt/diffusion/steady_state/continuous_3d_d00_p00_primal_strong_cochain_brick_3d_2_forman_flow.txt\
  build/$(MODE)/txt/diffusion/steady_state/continuous_3d_d00_p00_primal_weak_cochain_brick_3d_2_forman_input.txt\
  build/$(MODE)/txt/diffusion/steady_state/continuous_3d_d00_p00_primal_weak_cochain_brick_3d_2_forman_potential.txt\
  build/$(MODE)/txt/diffusion/steady_state/continuous_3d_d00_p00_primal_weak_cochain_brick_3d_2_forman_flow.txt\
  build/$(MODE)/txt/diffusion/steady_state/continuous_3d_d00_p00_mixed_weak_cochain_brick_3d_2_forman_input.txt\
  build/$(MODE)/txt/diffusion/steady_state/continuous_3d_d00_p00_mixed_weak_cochain_brick_3d_2_forman_solution.txt\
  build/$(MODE)/txt/diffusion/steady_state/continuous_3d_d00_p00_mixed_weak_cochain_brick_3d_2_forman_potential.txt\
