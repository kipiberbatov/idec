...
_txt_mesh_brick_2d_10 := \
  ...
  build/$(MODE)/txt/mesh/brick_2d_10_forman_node_curvature.txt\
  build/$(MODE)/txt/mesh/brick_2d_10_forman_metric_corrected.txt\
  build/$(MODE)/txt/mesh/brick_2d_10_forman_inner_corrected.txt\
  build/$(MODE)/txt/mesh/brick_2d_10_forman_cbd_star_corrected.txt\
  build/$(MODE)/txt/mesh/brick_2d_10_forman_laplacian_corrected.txt\
  build/$(MODE)/txt/mesh/brick_2d_10_forman_hodge_corrected.txt\
