_txt_diffusion_steady_state_continuous_2d_d00_p01 :=\
  ...
  build/$(MODE)/txt/diffusion/steady_state_continuous_2d_d00_p01_primal_strong_cochain_brick_2d_2_forman_input.txt\
  ...
  build/$(MODE)/txt/diffusion/steady_state_continuous_2d_d00_p01_primal_weak_cochain_brick_2d_2_forman_input.txt\
  ...
  build/$(MODE)/txt/diffusion/steady_state_continuous_2d_d00_p01_mixed_weak_cochain_brick_2d_2_forman_input.txt\
...
build/$(MODE)/txt/diffusion/steady_state_continuous_2d_d00_p01_exact_brick_2d_2_forman_flow.txt:\
  ...
  --raw $(word 2, $^)\
  $(word 2, $|)\
  diffusion_steady_state_continuous_2d_d00_p01_flow\
  --raw > $@
