...
\begin{proposition}
  ...
  Then
  \begin{equation}
    \nabla(v \usmile \sigma^p)
    = \nabla v \usmile \sigma^p + v \usmile \delta \sigma^p.
  \end{equation}
\end{proposition}
...
\begin{proof}
  \begin{equation}
    \nabla(v \usmile \sigma^p)
    := \nabla(v \otimes \sigma^p)
    = \nabla((v \otimes 1) \usmile \sigma^p)
    = \nabla(v \otimes 1) \usmile \sigma^p
      + (v \otimes 1) \usmile \delta \sigma^p
    =: \nabla v \usmile \sigma^p + v \usmile \delta \sigma^p.
  \end{equation}
\end{proof}
...
\begin{proposition}
  ...
  \begin{equation}
    \nabla(\sigma_V^p \usmile \tau^q)
    = \nabla \sigma_V^p \usmile \tau^q
      + (-1)^p \sigma_V^p \usmile \delta \tau^q.
  \end{equation}
\end{proposition}
...
\begin{proof}
  ...
  \begin{equation}
    \begin{split}
      \nabla(\sigma_V^p \usmile \tau^q)
      & = \nabla(v \usmile (\theta^p \smile \tau^q)) \\
      & = \nabla v \usmile (\theta^p \smile \tau^q)
          + v \usmile (\delta \theta^p \smile \tau^q)
          + (-1)^p v \usmile (\theta^p \smile \delta \tau^q) \\
      & = \nabla(v \usmile \theta^p) \usmile \tau^q
          + (-1)^p (v \usmile \theta^p) \usmile \delta \tau^q \\
      & = \nabla \sigma_V^p \usmile \tau^q
          + (-1)^p \sigma_V^p \usmile \delta \tau^q.
    \end{split}
  \end{equation}
...
\begin{example}
  ...
  \begin{equation}
    S \colon \Omega^0(\abs{K}, \R^d) \to C^0(K, C_1 K)
  \end{equation}
  as follows: if for $p = 0, ..., d - 1$,
  $u_p \colon \abs{K} \to \R$ is smooth with approximation
  $\eta_{(p)}^0 \in C^1 K = \widetilde{u_p}$, then
  \begin{equation}
    S(\sum_{p = 0}^{d - 1} u_p \frac{\partial}{\partial x_p})
  ...
  \begin{equation}
    S({\boldsymbol \nabla} f)
    = \sum_{p = 0}^{d - 1}
      e_p \usmile \widetilde{\frac{\partial}{\partial x_p} f}.
  \end{equation}
\end{example}
