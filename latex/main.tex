...
\begin{discussion}
  ...
  I will use notation coming from dependent type theory for functions whose
...
\begin{notation}
  ...
  We will denote by
  \begin{equation}
    \left.u\right|_T \in \Hom_\R({\rm Free}_\R(T), V)
  \end{equation}
...
\begin{discussion}
  ...
  \begin{itemize}
    \item temperature $u \in [t_0, \infty) \times C^0 K$;
    \item heat flux $q \in [t_0, \infty) \times C^1 K$;
    \item heat energy $Q \in [t_0, \infty) \times C^0 K$.
  \end{itemize}
  ...
  \begin{itemize}
    \item
      ...
      \begin{equation}
        \left.\left(\frac{\partial A}{\partial t}\right)\right|_{K_0'} =
        \left.(\delta_1^\star q)\right|_{K_0'} + f.
      \end{equation}
    \item
      Let
      ...
      \end{equation}
    \item
      Let $\pi_0 \colon C^0 K \to C^0 K$ be a material property of the nodes of
      $K$, playing the role of specific heat capacity
      ...
      \end{equation}
    \item
      Let $\pi_1 \colon C^0 1 \to C^0 1$ be a material property of the edges of
      $K$, playing the role of thermal conductivity
      (its matrix in the standard basis is diagonal).
  ...
  \begin{itemize}
    ...
    \item
      ...
      be the prescribed flux on the Neumann boundary.
      The \textbf{Neumann boundary condition} is given by
      \begin{equation}
        \left.\overline{q}\right|_{\Gamma_N} \cdot {\bf n} = g_N.
      \end{equation}
  \end{itemize} 
\end{discussion}

By substituting $q$ with $\delta_0 u$ and $A$ with $\pi_0 u$ we arrive at the
following formulation with only one unknown (the temperature $u$).
...
\begin{formulation}
  ...
  \begin{equation}
    \begin{split}
      & \text{Find $u \in [t_0, \infty) \times C^0 K$ such that} \\
      &
      \begin{cases}
        \left.\left(\frac{\partial (\pi_0 u)}{\partial t}\right)\right|_{K_0'} =
        \left.((\delta_1^\star \circ \pi_1 \circ \delta_0) u)\right|_{K_0'} + f
...
%
        \left.\overline{(\pi_1 \circ \delta_0) u}\right|_{\Gamma_N}
        \cdot {\bf n} = g_N
