...
\begin{definition}
  Let $d \in \N$, $M$ be a mesh of dimension $d$, $0 \leq p_f \leq d$.
...
\begin{definition}
  Let $d \in \N$, $M$ be a mesh of dimension $d$ with boundary operator
  $\partial$.
...
\begin{definition}
  Let $d \in \N$, $M$ be a mesh of dimension $d$.
...
\begin{proposition}
  Let $M$ be a mesh and $K$ be its Forman decomposition.
  Then $M$ is interval-simplicial if and only if $K$ is quasi-cubical.
\end{proposition}

\begin{proposition}
  Let $M$ be a mesh of dimension at most $2$.
...
\begin{proposition}
  Let $M$ be a mesh of dimension $3$.
